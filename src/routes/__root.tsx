...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Consteell | Steel Frame, Calhas, Rufos e Fachadas — Tatuí/SP" },
      { name: "twitter:title", content: "Consteell | Steel Frame, Calhas, Rufos e Fachadas — Tatuí/SP" },
